...
public class MobileCar extends Vehicle {
    ...
    /**
     * Constructor for MobeileCar. It uses the default car png for
     * representation. Initializes the random class. Random is used to move
     * system controlled cars at different directions.
     *
    ...
    /**
     * It determines next x and y coordinate of the vehicle based on its speed
     * and direction. It makes the vehicles stay in the visible area.
     */
    @Override
    void advance() {
    ...
    /**
     * It may or may not change the direction of the car. The probability that
     * it will change direction is 4%
     */
